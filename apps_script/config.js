...
const BacklogConfig = new Config('BacklogConfig', {
  ...
  // Date until when to pause scheduling of recurring items.
  // Provide string in 'YYYY-MM-DD' format. Leave empty to not pause.
  SCHEDULE_RECURRING_ITEMS_PAUSED_UNTIL: '',
